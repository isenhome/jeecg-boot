<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('dsp_creative')">导出</a-button>
    ...
    <dsp-creative-modal ref="modalForm" @ok="modalFormOk"></dsp-creative-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          ...
          exportXlsUrl: "/dsp/dspCreative/exportXls",
          importExcelUrl: "dsp/dspCreative/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'interactionType',text:'交互方式'})
        fieldList.push({type:'string',value:'interactionContent',text:'交互内容'})
        fieldList.push({type:'string',value:'pvMonitor',text:'展示监测'})
        fieldList.push({type:'string',value:'clickMonitor',text:'点击监测'})
