...
<script>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          ...
          edit: "/dsp/dspAdFormat/edit",
          queryById: "/dsp/dspAdFormat/queryById"
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'createBy','createTime','updateBy','updateTime','sysOrgCode','status','name'))
      },
    }
  }
</script>