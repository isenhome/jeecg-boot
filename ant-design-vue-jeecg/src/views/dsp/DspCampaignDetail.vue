<template>
  <page-layout :title="campaign.name">
    ...
    <a-card :bordered="false">
      <detail-list title="订单名称123">
        <detail-list-item term="广告主">已取货</detail-list-item>
        <detail-list-item term="行业">1234123421</detail-list-item>
        <detail-list-item term="开始时间">3214321432</detail-list-item>
