<template>
  <a-card :bordered="false">
    ...
    <dsp-media-modal ref="modalForm" @ok="modalFormOk"></dsp-media-modal>
  </a-card>
</template>
...
<script>
  ...
  import DspMediaModal from './modules/DspMediaModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/dsp/dspMedia/list",
          delete: "/dsp/dspMedia/delete",
          deleteBatch: "/dsp/dspMedia/deleteBatch",
          exportXlsUrl: "/dsp/dspMedia/exportXls",
          importExcelUrl: "dsp/dspMedia/importExcel",
