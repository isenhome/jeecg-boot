        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="平台编号" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['platformId']" placeholder="请输入平台编号"  ></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'createBy','createTime','updateBy','updateTime','sysOrgCode','status','name','platformId','mediaId','adFormatId','adRadioId','comment','sellType','interaction','imageType'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'createBy','createTime','updateBy','updateTime','sysOrgCode','status','name','platformId','mediaId','adFormatId','adRadioId','comment','sellType','interaction','imageType'))
      },
    }
  }
</script>