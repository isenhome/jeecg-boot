    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text,record">
          <router-link :to="{name:'dsp-DspCampaignDetail-@campaignId',params:{campaignId:record.id}}">详情</router-link>
          <a-divider type="vertical"/>
          <router-link :to="{name:'dsp-DspRptCampaign-@campaignId',params:{campaignId:record.id}}">报告</router-link>
          <a-divider type="vertical"/>
          <a-dropdown>
...
<!--                <a @click="handleDetail(record)">详情</a>-->
    ...
    <dsp-campaign-modal ref="modalForm" @ok="modalFormOk"></dsp-campaign-modal>
  </a-card>
</template>
